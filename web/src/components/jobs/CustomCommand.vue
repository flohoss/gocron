...
<template>
  <dialog :ref="(el) => emit('gotRef', el)" id="my_modal" class="modal modal-bottom sm:modal-middle">
    <form method="dialog" class="modal-box">
      ...
      <div class="py-4">
        <TextInput id="custom_command" title="Command" v-model="command" help="Example: snapshots" @keyup.enter="cmdButton.click()">
          <template #prefix><button disabled class="btn btn-outline join-item">restic</button></template>
        </TextInput>
